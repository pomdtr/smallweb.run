...
<body class="flex items-center justify-center min-h-screen bg-gray-900 text-gray-300 font-mono">
    <div class="container p-8 rounded shadow-md w-full max-w-md bg-gray-800 border border-gray-700">
        ...
        <form id="waitlist-form" class="space-y-5">
            <div>
                <input type="email" id="email" placeholder="Email" name="email" required class="input mt-1 block w-full px-3 py-2 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-700 text-gray-300 border border-gray-600">
            </div>
            <button type="submit" class="button w-full py-2 px-4 rounded-md bg-gray-700 text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Join</button>
        </form>
    </div>
    <script>
